...
- Chrome extension is a self-use client only; it should right-click page images, open Chrome Side Panel, call the configured TrustPic API, and render the returned `interpretation` without adding local detector logic.
...
- `docs/CHROME_EXTENSION.md`: unpacked Chrome extension client for self-use image upload and image URL analysis.
