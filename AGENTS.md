...
- Chrome extension is a self-use client only; it should right-click page images, call the configured TrustPic API, and render the returned `interpretation` without adding local detector logic.
